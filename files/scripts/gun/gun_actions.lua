local to_insert = {
    ...
    {
        id                  = "COWARD_SHOT",
        name                = "$action_name_toti_cowardshot",
        description         = "$action_desc_toti_cowardshot",
        author              = "Graham",
        sprite              = "mods/templeoftheinnocent/files/ui_gfx/gun_actions/cowardshot.png",
        related_projectiles = { "data/entities/projectiles/coward_bullet.xml" },
        type                = ACTION_TYPE_PROJECTILE,
        spawn_level         = "0",
        spawn_probability   = "0",
        price               = 160,
        ...
        max_uses            = -1,
        action              = function()
            add_projectile("data/entities/projectiles/coward_bullet.xml")
        end,
    },
}
